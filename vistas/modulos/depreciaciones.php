  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarDep">
      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-hover dt-responsive" width="100%">
        ...
        <?php
          ...
          $depreciaciones = ControladorDepres::ctrMostrarDepres($item, $valor);

          foreach ($depreciaciones as $key => $value) {
            ...
            echo '<tr>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-warning btnEditarDep" data-toggle="modal" data-target="#modalEditarDep" idDep="'.$value["id"].'"><i class="fa fa-pencil"></i></button>

                        <button class="btn btn-danger btnEliminarDep" idDep="'.$value["id"].'"><i class="fa fa-times"></i></button>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoDep" placeholder="Ingresar RFC Emisor" required>
      ...
      <?php
        ...
        $crearDep = new ControladorDepres();
        $crearDep -> ctrCrearDep();
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editarDep" name="editarDep"  required>
      ...
      <?php
        ...
        $editarDep = new ControladorDepres();
        $editarDep -> ctrEditarDep();
...
<?php
  ...
  $eliminarDep = new ControladorDepres();
  $eliminarDep -> ctrEliminarDep();

            ...
            echo '<tr>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-warning btnEditarPago" data-toggle="modal" data-target="#modalEditarPago" idPago="'.$value["id"].'"><i class="fa fa-pencil"></i></button>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="nuevoMetodop">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="nuevoFpagop">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="nuevoUsop">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editarPago" name="editarPago"  required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="editarMetodop">

                  <option value="" id="editarMetodop">Selecionar Metodo Pago</option>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="editarFpagop">

                  <option value="" id="editarFpagop">Selecionar Forma Pago</option>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="editarUsop">

                  <option value="" id="editarUsop">Selecionar Uso CFDI</option>
